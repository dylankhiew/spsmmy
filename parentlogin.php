...
<html lang="en">
  ...
  <body style=" padding-top:180px">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md">
  			<div class="jumbotron" style="opacity: 0.95">
            ...
            <img src="logo.png" style="width:80%"/>
					...
					<div class="wrap-input100 validate-input" data-validate = "Please enter ID">
						<input class="input100" type="text" name="id" required autofocus placeholder="ID">
...
if (isset($_POST["sendbtn"]))
{
	...
	$check_user = mysqli_query($conn,"select * from parent where parent_username = '$puname' and parent_password= '$ppass'")or die(mysqli_error($conn));

	if ($row=mysqli_fetch_assoc($check_user))
	{
		$_SESSION["pid"] = $row["parent_id"];
		mysqli_close($conn);
