  ...
  <body style="background-image: url();
        ...
        <div class="container">
          <div class="jumbotron" style="opacity: 0.9; color: black;">
            ...
            <div class="limiter">
              <a href="addteacher.php" class="btn btn-success" style="float: right;"><i class="fa fa-plus-circle" aria-hidden="true"></i> Teacher</a>
              <br></br>
              <form method="post" action="">
              <table class="table table-striped">
                  <?php
              $result=mysqli_query($conn,"SELECT * from teacher order by teacher.teacher_name");
            ...
            <td>
              ...
              <span class="input100">
                ...
                <br>
                <?php echo $row["teacher_contactno"]; ?>
                </br>
              </span>
              </td>
            <td style="float: right"><?php echo '<a href="editteacher.php?sid='.$row['teacher_id'].'" class="btn btn-info btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>EDIT</a>'; ?></td>
            </tr>
          <?php
          }
