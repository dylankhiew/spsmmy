  ...
  <body style="background-image: url(../background1.png);
    ...
    <div class="container">
      <div class="jumbotron" style="background: rgba(0, 0, 0, 0.7);border-radius:25px">
        <a><font color="white" size="6">Add Announcement</font></a>
        <br></br>

    <form method="post">
      <a><font size="4">Title: </font>
      ...
      <span class="input100">
  	     <textarea cols=50 rows="8" style="border-radius: 20px" class="form-control" style="font-size:16px; height:200px; overflow:scroll;" name="content" placeholder="Anything to elaborate?" required></textarea>
      </span>
    ...
    <div class="container-login100-form-btn">
      <div style="width:30%" class="wrap-login100-form-btn">
        <div class="login100-form-bgbtn"></div>
        <button class="login100-form-btn" input type="submit" class="btn btn-success" name="addbtn">Post!</button>
      </div>
    </div>
