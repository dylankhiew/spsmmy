			...
			<div class="jumbotron">
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Please enter ID">
						<input class="input100" style="color:black" type="text" name="id" placeholder="ID"required autofocus>
...
if (isset($_POST["sendbtn"]))
{
	...
	$check_user = mysqli_query($conn,"select * from teacher where teacher_username = '$tuname' and teacher_password= '$tpass'");
	if ($row=mysqli_fetch_assoc($check_user))
	{
		$_SESSION["tid"] = $row["teacher_id"];
		mysqli_close($conn);
