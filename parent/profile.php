  ...
  <body style="background-image: url(../background1.png);
          ...
          <div class="container">
            <div class="jumbotron" style="background: rgba(0, 0, 0, 0.7);border-radius:25px">
              ...
              ?>
              <span>
                <a><font color="white" size="7">Welcome</font><br>
            ...
            <span>
              <a>
                <font color="gray" size="5"><?php echo $row["student_name"] ?></font>
              </a>
            </span>
            <br></br>
...
if (isset($_POST["updatebtn"]))
{
	...
	mysqli_query($conn,"UPDATE student SET student_contactno='$tcontact', student_email='$temail', student_address='$taddress'
