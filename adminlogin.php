  			...
  			<div class="jumbotron" style="opacity: 0.95">
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Please enter ID">
						<input class="input100" type="text" name="id" required placeholder="ID" autofocus>
...
if (isset($_POST["sendbtn"]))
{
	...
	$check_user = mysqli_query($conn,"select * from admin where admin_username = '$auname' and admin_password= '$apass'");
